...
public class OrderPage {
    ...
    //поле ввода Имя
    private final By inputFieldNameLocator = By.cssSelector("input.Input_Input__1iN_Z[placeholder='* Имя']");
    //поле ввода Фамилия
    private final By inputFieldSurnameLocator = By.cssSelector("input.Input_Input__1iN_Z[placeholder='* Фамилия']");
    //поле ввода Адрес
    private final By inputFieldAdressLocator = By.cssSelector("input.Input_Input__1iN_Z[placeholder='* Адрес: куда привезти заказ']");
    //дропдаун Станция метро
    private final By dropdownSubwayLocator = By.cssSelector("input.select-search__input[placeholder='* Станция метро']");
    //поле ввода Телефон
    private final By inputFieldPhoneLocator = By.cssSelector("input.Input_Input__1iN_Z[placeholder='* Телефон: на него позвонит курьер']");
    //кнопка "Далее"
    private final By buttonNextStepLocator = By.cssSelector("button.Button_Button__ra12g.Button_Middle__1CSJM");
    //поле ввода Дата
    private final By inputFieldCalendarLocator = By.cssSelector("input.Input_Input__1iN_Z[placeholder='* Когда привезти самокат']");
    //дропдаун с списком сроков аренды
    private final By dropDownRentTimeListLocator = By.cssSelector("div.Dropdown-control[aria-haspopup='listbox']");
    //элемент из списка
    private final By clickDropdownRentTimeItemLocator = By.xpath("//div[@class='Dropdown-menu']/div[text()='пятеро суток']");
    //чекбокс с цветом
    private final By clickScooterColorLocator = By.cssSelector("#black");
    //поле ввода Комментарий
    private final By enterCommentClientLocator = By.cssSelector("input.Input_Input__1iN_Z.Input_Responsible__1jDKN[placeholder='Комментарий для курьера']");
    //кнопка "Заказать"
    private final By clickOrderButtonSecondPageLocator = By.xpath("//button[contains(@class, 'Button_Button__ra12g') and contains(@class, 'Button_Middle__1CSJM') and text()='Заказать']");
