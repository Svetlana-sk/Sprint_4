...
public class ModalPageOrderSuccess {
    ...
    //кнопка "Посмотреть статус" на финальной модалке
    private final By checkSuccessOrderLocator = By.xpath("//button[contains(@class, 'Button_Button__ra12g') and contains(@class, 'Button_Middle__1CSJM') and text()='Посмотреть статус']");
